...
* *Code repository:*
 https://github.com/mmprogrami/smtp
* *Where to file issues:*
 https://github.com//mmprogrami/smtp/issues
* *Maintained by:*
 https://mmprogrami.nl[MMProgrami]
* *Supported architectures:*
 https://packages.debian.org/<>/exim4-daemon-light[Any architecture that has the Debian `exim4-daemon-light` package]
